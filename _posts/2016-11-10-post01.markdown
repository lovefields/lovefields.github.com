...
그리고 <code>choco install ruby2.devkit</code>를 입력해 <strong class="blue">devkit</strong>도 깔아줍니다
...
그 다음 다시 <strong class="blue">CMD</strong> 창에서 <code>strongundle install</code>을 적어줘 실행합니다.<br>
