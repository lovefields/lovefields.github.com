...
<code>/* 2016-11-13 추가 / 프론트 엔드 개발 그륩 - 강동훈 님 */</code><br>
Windows 7 64bit에서 설치중입니다. 루비에서 막혀서<br>"Unable to download data from https:rubygemsorg - SSL_connect returned=1 errno=0 state=SSLv3 read server certificate B: certificate verify failed"
