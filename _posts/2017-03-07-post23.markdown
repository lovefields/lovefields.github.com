...
때문에 Button을 사용할 경우 오류가 발생한다. <br>
...
{% endhighlight %}
POSITION_NONE: ViewPager.destroyItem()이 호출되어 Item이 삭제된 것으로 판단해 onCreateView를 호출한다.<br>
<br>
{% highlight java %}
flagChange = true;
