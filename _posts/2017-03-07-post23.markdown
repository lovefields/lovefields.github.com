...
Swipe: (보이기 전)isVisibleToUser(false) - onCreate - onCreateView - onResume - (보이면)isVisibleToUser(true)<br>
Button : (이동)isVisibleToUser(false) - isVisibleToUser(true) - onCreate - onCreateView - onResume <br>
