    ...
    private void setItemTouchHelper() {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            private void itemDrawChange() {
                ...
                removeMark.setColorFilter(Color.RED, PorterDuff.Mode.SRC_ATOP);
            ...
            public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                ...
                // 이미 Swipe 된 viewHolder 를 호출하는 현상 방지
		...
		//dX(dY): 사용자 동작에 의한 수평(수직) 변화의 양
                ...
                int intrinsicWidth = removeMark.getIntrinsicWidth(); // Intrinsic: 본질적 - removeMark 의 실제 길이
